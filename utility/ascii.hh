#ifndef _robin_file_hh_
#define _robin_file_hh_
        ...
        private:
            ...
            class pull< x_type[ x_size ] >
            {
                public:
                    ...
                    {
                        for( size_t t_index = 0; t_index < x_size; t_index++ )
                        {
            ...
            class push< vector< x_value > >
            {
                public:
                    ...
                    {
                        const size_t t_size = p_vector.size();
                        p_stream << t_size << "\n";
            ...
            class push< list< x_value > >
            {
                public:
                    ...
                    {
                        const size_t t_size = p_list.size();
                        p_stream << t_size << "\n";
            ...
            class pull< map< x_key, x_value > >
            {
                public:
                    pull( ascii& p_stream, map< x_key, x_value >& p_map )
                    {
                        ...
                        x_value t_value;
                        p_map.clear();
                        for( size_t t_index = 0; t_index < t_size; t_index++ )
                        {
                            p_stream >> t_key;
                            p_stream >> t_value;
            ...
            class push< map< x_key, x_value > >
            {
                public:
                    ...
                    {
                        const size_t t_size = p_map.size();
                        p_stream << t_size << "\n";
