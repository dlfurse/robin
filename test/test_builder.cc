...
class child
{
    ...
    public:
        ...
        void second( const double& p_real_t )
        {
            f_second = p_real_t;
            return;
        }
...
static const int s_child =
    child_builder::field< string >( &child::first, "first" ) +
    child_builder::field< double >( &child::second, "second" );
...
static const int s_parent =
    parent_builder::field< child >( &parent::add, "add" );
