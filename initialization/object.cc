...
namespace robin
{
    ...
    pair< string, value* > object::at( const size_t& p_index )
    {
        string t_key;
        value* t_value;
    ...
    pair< string, const value* > object::at( const size_t& p_index ) const
    {
        string t_key;
        value* t_value;
        if( p_index < f_vector.size() )
    ...
    value* object::at( const string& p_key, const size_t& p_index )
    {
    ...
    const value* object::at( const string& p_key, const size_t& p_index ) const
    {
        size_t t_index = p_index;
